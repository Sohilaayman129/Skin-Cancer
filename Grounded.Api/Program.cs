...
// Serve Angular frontend static files from wwwroot
app.UseDefaultFiles();
app.UseStaticFiles();

app.MapControllers();

// SPA Fallback: If static index.html exists in wwwroot, serve Angular UI; else return API info JSON
app.MapFallback(async context =>
{
    var webRoot = app.Environment.WebRootPath ?? Path.Combine(builder.Environment.ContentRootPath, "wwwroot");
